...
confused with overall BAC Network Protocol consensus changes.
...
Patches that change BAC consensus rules are considerably more involved than
...
Where a patch set proposes to change the BAC consensus, it must have been
