Contributing to VIP Core
============================

The VIP Core project operates an open contributor model where anyone is
...
The following applies to code changes to the VIP Core project, and is not to be
confused with overall VIP Network Protocol consensus changes.

Whether a pull request is merged into VIP Core rests with the project merge
...
Patches that change VIP consensus rules are considerably more involved than
...
Where a patch set proposes to change the VIP consensus, it must have been
...
The project leader is the release manager for each VIP Core release.
