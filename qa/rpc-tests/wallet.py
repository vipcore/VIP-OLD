...
#   c) node1 mines 32 blocks, so now node 0 has 60001VIP, node 1 has 4250VIP, node2 has none.
#   d) node0 sends 601 VIP to node2, in two transactions (301 VIP, then 300 VIP).
