...
static const int DEFAULT_CUSTOMVIPKUPTHRESHOLD = 1;
...
public:
    ...
    */
    ...
    bool fBackupMints;
    std::unique_ptr<CzVIPTracker> zpivTracker;
    ...
    {
        zwalletMain = zwallet;
        zpivTracker = std::unique_ptr<CzVIPTracker>(new CzVIPTracker(strWalletFile));
    }
