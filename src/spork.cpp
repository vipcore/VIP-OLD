...
// Vip: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
      ...
      //  if (nSporkID == SPORK_9_MASTERNODE_BUDGET_ENFORCEMENT) r = SPORK_9_MASTERNODE_BUDGET_ENFORCEMENT_DEFAULT; //Vip not used
	...
	if (nSporkID == SPORK_17_POS_ENFORCEMENT) r = SPORK_17_POS_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    //if (strName == "SPORK_9_MASTERNODE_BUDGET_ENFORCEMENT") return SPORK_9_MASTERNODE_BUDGET_ENFORCEMENT; // Vip not used
    ...
    if (strName == "SPORK_17_POS_ENFORCEMENT") return SPORK_17_POS_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    //if (id == SPORK_9_MASTERNODE_BUDGET_ENFORCEMENT) return "SPORK_9_MASTERNODE_BUDGET_ENFORCEMENT"; // Vip not used
    ...
    if (id == SPORK_17_POS_ENFORCEMENT) return "SPORK_17_POS_ENFORCEMENT";
