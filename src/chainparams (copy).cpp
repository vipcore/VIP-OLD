...
public:
    CMainParams()
    {
        ...
        nTargetSpacing = 1.5 * 60;  // VIP: 1 minute
        nMaturity = 15;
        nMasternodeCountDrift = 20;
        nMaxMoneyOut = 1000000 * COIN;
        nMNCollateral = 4000 * COIN;
         ...
         *     CTxOut(nValue=50.00000000, scriptPubKey=0xA9037VIP7050C479B121CF)
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "VIP Genesis Block: 2018/09/05 12:00:00";
        ...
        genesis.nNonce = 251118;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000a9102c6ea0ab5872368efa255e71bdf1cb389f3298bce7be5b10abae7f6"));
        assert(genesis.hashMerkleRoot == uint256("0xa71c10900738dad7bfbb926f3b5fef970a0ed579c31ba120714ec554c988e985"));
        ...
        vSeeds.push_back(CDNSSeedData("149.28.233.226", "149.28.233.226"));
        vSeeds.push_back(CDNSSeedData("140.82.46.225", "140.82.46.225"));
        vSeeds.push_back(CDNSSeedData("209.250.240.121", "209.250.240.121"));
        vSeeds.push_back(CDNSSeedData("95.179.164.80", "95.179.164.80"));
        vSeeds.push_back(CDNSSeedData("149.28.178.26", "149.28.178.26"));
        vSeeds.push_back(CDNSSeedData("198.13.50.187", "198.13.50.187"));

        // VIP addresses start with 'B'
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "vip-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "vip-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        vSeeds.push_back(CDNSSeedData("88.198.192.110", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 85); // Testnet vip addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 199);  // Testnet vip script addresses start with '8' or '9'
...
public:
    CRegTestParams()
    {
        ...
        assert(hashGenesisBlock == uint256("0x717738f36351b9b5067bc5091dd11614cc49de3ec9c20eafb90bdb0d3de910be"));
