...
extern UniValue setzVIPseed(const UniValue& params, bool fHelp);
extern UniValue getzVIPseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzVIP(const UniValue& params, bool fHelp);
extern UniValue dzVIPstate(const UniValue& params, bool fHelp);
