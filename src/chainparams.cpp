...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
      (0, uint256("0x00000af0c0eb9db08c9fc913a36c2676ad5fcc226838ed2da4139b94e777723c"))
      (500, uint256("0xd007d32decc8d3509c9b81aa169282d213a1dc55aac47d8acf7876c3ae21050d"))
...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "Corona Virus outbreak, Seems to be scary - Global  Pandemics spreading, 2020";
        ...
        strSporkKey = "03da4642941f1a40e9daf4a691b744e0e04637ed3ca0a11717f604a92a17fd34e0";
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet vip addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet vip script addresses start with '8' or '9'
