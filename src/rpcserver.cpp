...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Vip features */
        {"vip", "masternode", &masternode, true, true, false},
        {"vip", "masternodelist", &masternodelist, true, true, false},
        {"vip", "mnbudget", &mnbudget, true, true, false},
        {"vip", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"vip", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vip", "mnsync", &mnsync, true, true, false},
        {"vip", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"vip", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use vipd, or the -server option to vip-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
