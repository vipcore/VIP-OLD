                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzVIPPathCustom = GetArg("-zVIPbackuppath", "");
    ...
    if(!strzVIPPathCustom.empty()) {
        ui->wallet_customzVIPbackuppath->setText(QString::fromStdString(strzVIPPathCustom));
        ui->wallet_customzVIPbackuppath_label->setVisible(true);
        ui->wallet_customzVIPbackuppath->setVisible(true);
    }
