...
Setup
---------
Configuring the github-merge tool for the BAC repository is done in the following way:

    git config githubmerge.repository BAC-Project/BAC
...
A script to optimize png files in the BAC
