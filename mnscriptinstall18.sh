...
cd ~
echo "****************************************************************************"
echo "* This script will install and configure your VIP Coin masternodes.       *"
echo "*                                                                         *"
echo "*    If you have any issues please ask for help on the VIP discord.       *"
echo "*                      https://discord.gg/xKPXvyw                          *"
echo "*                        https://vipcore.vip/                             *"
echo "****************************************************************************"
echo "" 
echo ""
echo ""
...
echo ""
wget https://github.com/vipcore/VIP/releases/download/V.1.0/linux-18-daemon.zip
unzip linux-18-daemon.zip
echo ""
...
read IPDEFAULT
	...
	./vipd -daemon
	echo "if server start failure try ./vipd -reindex"
	echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
	echo "!                                                 !"
