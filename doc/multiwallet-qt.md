...
In order to support loading of multiple wallets in vip-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vip.cpp.
...
Changes to vip.cpp
----------------------
vip.cpp is the entry point into vip-qt, and as such, will require some minor modifications to provide hooks for
