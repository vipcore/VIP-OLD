...
```
./vipd -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:989
```
...
HiddenServicePort 989 127.0.0.1:28181
...
your vipd's P2P listen port (28181 by default).
```
-externalip=X   You can tell vip about its publicly reachable address using
                this option, and this can be a .onion address. Given the above
                configuration, you can find your onion address in
                /var/lib/tor/vip-service/hostname. Onion addresses are given
...
```
./vipd -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -listen
```
...
and open port 28181 on your firewall (or use -upnp).
