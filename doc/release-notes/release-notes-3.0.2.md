...
- #292 `feadab4` Additional checks for double spending of zVip serials. (presstab)
...
- #280 `fdc182d` [Wallet] Fix zVip spending errors. (presstab)
- #282 `310f216` [Wallet] Count pending zVip balance for automint. (presstab)
...
- #291 `cb314e6` [Qt] zVip control quantity/amount fixes (rejectedpromise)
