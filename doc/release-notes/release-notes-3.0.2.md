VIP Core version 3.0.2 is now available from:
...
- #292 `feadab4` Additional checks for double spending of zBitalley serials. (presstab)
...
- #280 `fdc182d` [Wallet] Fix zBitalley spending errors. (presstab)
- #282 `310f216` [Wallet] Count pending zBitalley balance for automint. (presstab)
...
- #291 `cb314e6` [Qt] zBitalley control quantity/amount fixes (rejectedpromise)
