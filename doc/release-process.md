...
- Detached signatures will then be committed to the [vip-detached-sigs](https://github.com/BAC-Project/vip-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the vip.org server*.
