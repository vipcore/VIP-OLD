...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/VipCRYPTO/Vip/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/VipCRYPTO/Vip-DETACHED.SIGS.git
...
### Build and sign Vip Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit vip=v${VERSION} ../vip/contrib/gitian-descriptors/gitian-osx.yml
...
space *do not upload these to the http://bit.vips/ server*.
