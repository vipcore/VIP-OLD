...
pkgdatadir = $(datadir)/vip
pkgincludedir = $(includedir)/vip
pkglibdir = $(libdir)/vip
pkglibexecdir = $(libexecdir)/vip
...
CONFIG_HEADER = $(top_builddir)/src/config/vip-config.h
...
ACLOCAL = ${SHELL} /mnt/VIP/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/i686-w64-mingw32-ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /mnt/VIP/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /mnt/VIP/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /mnt/VIP/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = vip-cli
BITCOIN_DAEMON_NAME = vipd
BITCOIN_GUI_NAME = vip-qt
BITCOIN_TX_NAME = vip-tx
BOOST_CHRONO_LIB = -lboost_chrono-mt-s
BOOST_CPPFLAGS = -DBOOST_SP_USE_STD_ATOMIC -DBOOST_AC_USE_STD_ATOMIC -mthreads -I/mnt/VIP/depends/i686-w64-mingw32/share/../include
BOOST_FILESYSTEM_LIB = -lboost_filesystem-mt-s
BOOST_LDFLAGS = -L/mnt/VIP/depends/i686-w64-mingw32/share/../lib
BOOST_LIBS = -L/mnt/VIP/depends/i686-w64-mingw32/share/../lib -lboost_system-mt-s -lboost_filesystem-mt-s -lboost_program_options-mt-s -lboost_thread_win32-mt-s -lboost_chrono-mt-s
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /mnt/VIP/build-aux/missing makeinfo
MAKENSIS = none
MANIFEST_TOOL = :
...
install_sh = ${SHELL} /mnt/VIP/build-aux/install-sh
...
pdfdir = ${docdir}
prefix = /mnt/VIP/depends/i686-w64-mingw32
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_vip_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_vip_coverage.info test_vip.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/BAC-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/vip-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/vip-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/vip-config.h
$(top_srcdir)/src/config/vip-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/vip-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/BAC-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BAC-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BAC-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_vip.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_vip -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_vip_filtered.info: test_vip.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_vip_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_vip_coverage.info: baseline_filtered_combined.info test_vip_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_vip_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_vip_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_vip_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_vip.coverage/.dirstamp:  test_vip_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_vip.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_vip.coverage/ total.coverage/ $(OSX_APP)
